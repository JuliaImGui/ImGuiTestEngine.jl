...
function Base.getproperty(x::Ptr{ImGuiTestCoroutineInterface}, f::Symbol)
    ...
    f === :DestroyFunc && return Ptr{Ptr{Cvoid}}(x + 8)
    f === :RunFunc && return Ptr{Ptr{Cvoid}}(x + 16)
    f === :YieldFunc && return Ptr{Ptr{Cvoid}}(x + 24)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiTestEngineIO}, f::Symbol)
    ...
    f === :SrcFileOpenFunc && return Ptr{Ptr{ImGuiTestEngineSrcFileOpenFunc}}(x + 8)
    f === :ScreenCaptureFunc && return Ptr{Ptr{ImGuiScreenCaptureFunc}}(x + 16)
    f === :SrcFileOpenUserData && return Ptr{Ptr{Cvoid}}(x + 24)
    f === :ScreenCaptureUserData && return Ptr{Ptr{Cvoid}}(x + 32)
    f === :ConfigSavedSettings && return Ptr{Bool}(x + 40)
    f === :ConfigRunSpeed && return Ptr{ImGuiTestRunSpeed}(x + 44)
    f === :ConfigStopOnError && return Ptr{Bool}(x + 48)
    f === :ConfigBreakOnError && return Ptr{Bool}(x + 49)
    f === :ConfigKeepGuiFunc && return Ptr{Bool}(x + 50)
    f === :ConfigRestoreFocusAfterTests && return Ptr{Bool}(x + 51)
    f === :ConfigCaptureEnabled && return Ptr{Bool}(x + 52)
    f === :ConfigCaptureOnError && return Ptr{Bool}(x + 53)
    f === :ConfigNoThrottle && return Ptr{Bool}(x + 54)
    f === :ConfigMouseDrawCursor && return Ptr{Bool}(x + 55)
    f === :ConfigFixedDeltaTime && return Ptr{Cfloat}(x + 56)
    f === :PerfStressAmount && return Ptr{Cint}(x + 60)
    f === :GitBranchName && return Ptr{NTuple{64, Cchar}}(x + 64)
    f === :ConfigVerboseLevel && return Ptr{ImGuiTestVerboseLevel}(x + 128)
    f === :ConfigVerboseLevelOnError && return Ptr{ImGuiTestVerboseLevel}(x + 132)
    f === :ConfigLogToTTY && return Ptr{Bool}(x + 136)
    f === :ConfigLogToDebugger && return Ptr{Bool}(x + 137)
    f === :ConfigLogToFunc && return Ptr{Ptr{ImGuiTestEngineLogFunc}}(x + 144)
    f === :ConfigLogToFuncUserData && return Ptr{Ptr{Cvoid}}(x + 152)
    f === :MouseSpeed && return Ptr{Cfloat}(x + 160)
    f === :MouseWobble && return Ptr{Cfloat}(x + 164)
    f === :ScrollSpeed && return Ptr{Cfloat}(x + 168)
    f === :TypingSpeed && return Ptr{Cfloat}(x + 172)
    f === :ActionDelayShort && return Ptr{Cfloat}(x + 176)
    f === :ActionDelayStandard && return Ptr{Cfloat}(x + 180)
    f === :VideoCaptureEncoderPath && return Ptr{NTuple{256, Cchar}}(x + 184)
    f === :VideoCaptureEncoderParams && return Ptr{NTuple{256, Cchar}}(x + 440)
    f === :GifCaptureEncoderParams && return Ptr{NTuple{512, Cchar}}(x + 696)
    f === :VideoCaptureExtension && return Ptr{NTuple{8, Cchar}}(x + 1208)
    f === :ConfigWatchdogWarning && return Ptr{Cfloat}(x + 1216)
    f === :ConfigWatchdogKillTest && return Ptr{Cfloat}(x + 1220)
    f === :ConfigWatchdogKillApp && return Ptr{Cfloat}(x + 1224)
    f === :ExportResultsFilename && return Ptr{Ptr{Cchar}}(x + 1232)
    f === :ExportResultsFormat && return Ptr{ImGuiTestEngineExportFormat}(x + 1240)
    f === :CheckDrawDataIntegrity && return Ptr{Bool}(x + 1244)
    f === :IsRunningTests && return Ptr{Bool}(x + 1245)
    f === :IsRequestingMaxAppSpeed && return Ptr{Bool}(x + 1246)
    f === :IsCapturing && return Ptr{Bool}(x + 1247)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiTest}, f::Symbol)
    ...
    f === :Group && return Ptr{ImGuiTestGroup}(x + 16)
    f === :NameOwned && return Ptr{Bool}(x + 20)
    f === :ArgVariant && return Ptr{Cint}(x + 24)
    f === :Flags && return Ptr{Cint}(x + 28)
    f === :GuiFunc && return Ptr{Ptr{ImGuiTestGuiFunc}}(x + 32)
    f === :TestFunc && return Ptr{Ptr{ImGuiTestTestFunc}}(x + 40)
    f === :TeardownFunc && return Ptr{Ptr{ImGuiTestTestFunc}}(x + 48)
    f === :UserData && return Ptr{Ptr{Cvoid}}(x + 56)
    f === :SourceFile && return Ptr{Ptr{Cchar}}(x + 64)
    f === :SourceLine && return Ptr{Cint}(x + 72)
    f === :SourceLineEnd && return Ptr{Cint}(x + 76)
    f === :Output && return Ptr{ImGuiTestOutput}(x + 80)
    f === :VarsSize && return Ptr{Culong}(x + 160)
    f === :VarsConstructor && return Ptr{Ptr{ImGuiTestVarsConstructor}}(x + 168)
    f === :VarsPostConstructor && return Ptr{Ptr{ImGuiTestVarsPostConstructor}}(x + 176)
    f === :VarsPostConstructorUserFn && return Ptr{Ptr{Cvoid}}(x + 184)
    f === :VarsDestructor && return Ptr{Ptr{ImGuiTestVarsDestructor}}(x + 192)
    return getfield(x, f)
end
...
struct ImGuiTestEnginePerfRecord
    RawValueMs::Cdouble
    Average100::ImMovingAverage_double
    Average500::ImMovingAverage_double
end
...
@cenum ImGuiPerfToolReportType::UInt32 begin
    ImGuiPerfToolReportType_Details = 0
    ImGuiPerfToolReportType_Batches = 1
end
...
struct ImGuiPerfTool
    ...
    _ReportType::ImGuiPerfToolReportType
    _BaselineBatchIndex::Cint
    _BaselineTestIndex::Cint
    _BaselineTimestamp::Culonglong
    _BaselineBuildId::Culonglong
    _BaselineTestName::NTuple{128, Cchar}
...
struct ImGuiTestEngine
    ...
    UiPerfToolOpen::Bool
    UiLogHeight::Cfloat
    PerfTimestampPreNewFrame::Culonglong
    PerfTimestampPreRender::Culonglong
    PerfTimestampPreSwap::Culonglong
    PerfTimestampPostSwap::Culonglong
    PerfDtApp::ImGuiTestEnginePerfRecord
    PerfDtPreNewFrameToPreRender::ImGuiTestEnginePerfRecord
    PerfDtPreRenderToPreSwap::ImGuiTestEnginePerfRecord
    PerfDtPreNewFrameToPreSwap::ImGuiTestEnginePerfRecord
    PerfDtPreSwapToPostSwap::ImGuiTestEnginePerfRecord
...
function Base.getproperty(x::Ptr{ImGuiTestEngine}, f::Symbol)
    ...
    f === :UiContextTarget && return Ptr{Ptr{ImGuiContext}}(x + 1248)
    f === :UiContextActive && return Ptr{Ptr{ImGuiContext}}(x + 1256)
    f === :Started && return Ptr{Bool}(x + 1264)
    f === :UiContextHasHooks && return Ptr{Bool}(x + 1265)
    f === :BatchStartTime && return Ptr{Culonglong}(x + 1272)
    f === :BatchEndTime && return Ptr{Culonglong}(x + 1280)
    f === :FrameCount && return Ptr{Cint}(x + 1288)
    f === :OverrideDeltaTime && return Ptr{Cfloat}(x + 1292)
    f === :TestsAll && return Ptr{ImVector_ImGuiTest_Ptr}(x + 1296)
    f === :TestsQueue && return Ptr{ImVector_ImGuiTestRunTask}(x + 1312)
    f === :TestContext && return Ptr{Ptr{ImGuiTestContext}}(x + 1328)
    f === :TestsSourceLinesDirty && return Ptr{Bool}(x + 1336)
    f === :InfoTasks && return Ptr{ImVector_ImGuiTestInfoTask_Ptr}(x + 1344)
    f === :GatherTask && return Ptr{ImGuiTestGatherTask}(x + 1360)
    f === :FindByLabelTask && return Ptr{ImGuiTestFindByLabelTask}(x + 1392)
    f === :TestQueueCoroutine && return Ptr{Ptr{Cvoid}}(x + 1432)
    f === :TestQueueCoroutineShouldExit && return Ptr{Bool}(x + 1440)
    f === :StringBuilderForChecks && return Ptr{ImGuiTextBuffer}(x + 1448)
    f === :Inputs && return Ptr{ImGuiTestInputs}(x + 1464)
    f === :Abort && return Ptr{Bool}(x + 1520)
    f === :UiSelectAndScrollToTest && return Ptr{Ptr{ImGuiTest}}(x + 1528)
    f === :UiSelectedTest && return Ptr{Ptr{ImGuiTest}}(x + 1536)
    f === :UiFilterTests && return Ptr{Ptr{Str}}(x + 1544)
    f === :UiFilterPerfs && return Ptr{Ptr{Str}}(x + 1552)
    f === :UiFilterByStatusMask && return Ptr{Cuint}(x + 1560)
    f === :UiMetricsOpen && return Ptr{Bool}(x + 1564)
    f === :UiDebugLogOpen && return Ptr{Bool}(x + 1565)
    f === :UiCaptureToolOpen && return Ptr{Bool}(x + 1566)
    f === :UiStackToolOpen && return Ptr{Bool}(x + 1567)
    f === :UiPerfToolOpen && return Ptr{Bool}(x + 1568)
    f === :UiLogHeight && return Ptr{Cfloat}(x + 1572)
    f === :PerfTimestampPreNewFrame && return Ptr{Culonglong}(x + 1576)
    f === :PerfTimestampPreRender && return Ptr{Culonglong}(x + 1584)
    f === :PerfTimestampPreSwap && return Ptr{Culonglong}(x + 1592)
    f === :PerfTimestampPostSwap && return Ptr{Culonglong}(x + 1600)
    f === :PerfDtApp && return Ptr{ImGuiTestEnginePerfRecord}(x + 1608)
    f === :PerfDtPreNewFrameToPreRender && return Ptr{ImGuiTestEnginePerfRecord}(x + 1680)
    f === :PerfDtPreRenderToPreSwap && return Ptr{ImGuiTestEnginePerfRecord}(x + 1752)
    f === :PerfDtPreNewFrameToPreSwap && return Ptr{ImGuiTestEnginePerfRecord}(x + 1824)
    f === :PerfDtPreSwapToPostSwap && return Ptr{ImGuiTestEnginePerfRecord}(x + 1896)
    f === :PerfTool && return Ptr{Ptr{ImGuiPerfTool}}(x + 1968)
    f === :CaptureTool && return Ptr{ImGuiCaptureToolUI}(x + 1976)
    f === :CaptureContext && return Ptr{ImGuiCaptureContext}(x + 2872)
    f === :CaptureCurrentArgs && return Ptr{Ptr{ImGuiCaptureArgs}}(x + 3080)
    f === :PreSwapCalled && return Ptr{Bool}(x + 3088)
    f === :PostSwapCalled && return Ptr{Bool}(x + 3089)
    f === :ToolDebugRebootUiContext && return Ptr{Bool}(x + 3090)
    f === :ToolSlowDown && return Ptr{Bool}(x + 3091)
    f === :ToolSlowDownMs && return Ptr{Cint}(x + 3092)
    f === :BackupConfigRunSpeed && return Ptr{ImGuiTestRunSpeed}(x + 3096)
    f === :BackupConfigNoThrottle && return Ptr{Bool}(x + 3100)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiTestContext}, f::Symbol)
    ...
    f === :UiContext && return Ptr{Ptr{ImGuiContext}}(x + 824)
    f === :EngineIO && return Ptr{Ptr{ImGuiTestEngineIO}}(x + 832)
    f === :Test && return Ptr{Ptr{ImGuiTest}}(x + 840)
    f === :TestOutput && return Ptr{Ptr{ImGuiTestOutput}}(x + 848)
    f === :OpFlags && return Ptr{Cint}(x + 856)
    f === :PerfStressAmount && return Ptr{Cint}(x + 860)
    f === :FrameCount && return Ptr{Cint}(x + 864)
    f === :FirstTestFrameCount && return Ptr{Cint}(x + 868)
    f === :FirstGuiFrame && return Ptr{Bool}(x + 872)
    f === :HasDock && return Ptr{Bool}(x + 873)
    f === :CaptureArgs && return Ptr{Ptr{ImGuiCaptureArgs}}(x + 880)
    f === :Engine && return Ptr{Ptr{ImGuiTestEngine}}(x + 888)
    f === :Inputs && return Ptr{Ptr{ImGuiTestInputs}}(x + 896)
    f === :RunFlags && return Ptr{Cint}(x + 904)
    f === :ActiveFunc && return Ptr{ImGuiTestActiveFunc}(x + 908)
    f === :RunningTime && return Ptr{Cdouble}(x + 912)
    f === :ActionDepth && return Ptr{Cint}(x + 920)
    f === :CaptureCounter && return Ptr{Cint}(x + 924)
    f === :ErrorCounter && return Ptr{Cint}(x + 928)
    f === :Abort && return Ptr{Bool}(x + 932)
    f === :PerfRefDt && return Ptr{Cdouble}(x + 936)
    f === :PerfIterations && return Ptr{Cint}(x + 944)
    f === :RefStr && return Ptr{NTuple{256, Cchar}}(x + 948)
    f === :RefID && return Ptr{Cuint}(x + 1204)
    f === :RefWindowID && return Ptr{Cuint}(x + 1208)
    f === :InputMode && return Ptr{ImGuiInputSource}(x + 1212)
    f === :TempString && return Ptr{ImVector_char}(x + 1216)
...
@cenum ImGuiTestOpFlags_::UInt32 begin
    ...
    ImGuiTestOpFlags_NoScroll = 4096
end
...
function cImStrTrimTrailingZeroesFromFloat(buf, buf_end)
    ccall((:cImStrTrimTrailingZeroesFromFloat, libcimgui), Cvoid, (Ptr{Cchar}, Ptr{Cchar}), buf, buf_end)
end
...
# no prototype is found for this function at cimgui_te.h:860:24, please use with caution
function cImTimeGetInMicroseconds()
    ccall((:cImTimeGetInMicroseconds, libcimgui), UInt64, ())
end

function cImTimestampToISO8601(timestamp_us, out_date)
    ccall((:cImTimestampToISO8601, libcimgui), Cvoid, (Culong, Ptr{Str}), timestamp_us, out_date)
end
...
# no prototype is found for this function at cimgui_te.h:864:35, please use with caution
...
# no prototype is found for this function at cimgui_te.h:870:20, please use with caution
...
function cTableDiscardInstance(table_id)
    ccall((:cTableDiscardInstance, libcimgui), Cvoid, (Cuint,), table_id)
end

function cTableDiscardSettings(table_id)
    ccall((:cTableDiscardSettings, libcimgui), Cvoid, (Cuint,), table_id)
end
...
function cSaveIniSettingsToVector(out)
    ccall((:cSaveIniSettingsToVector, libcimgui), Cvoid, (Ptr{ImVector_char},), out)
end
...
# no prototype is found for this function at cimgui_te.h:914:33, please use with caution
function cImGuiTestEngine_GetTempStringBuilder()
    ccall((:cImGuiTestEngine_GetTempStringBuilder, libcimgui), Ptr{ImGuiTextBuffer}, ())
end

# no prototype is found for this function at cimgui_te.h:916:33, please use with caution
...
function cImGuiTestEngine_PreSwap(engine)
    ccall((:cImGuiTestEngine_PreSwap, libcimgui), Cvoid, (Ptr{ImGuiTestEngine},), engine)
end
...
# no prototype is found for this function at cimgui_te.h:943:20, please use with caution
function cImGuiTestEngine_InstallDefaultCrashHandler()
    ccall((:cImGuiTestEngine_InstallDefaultCrashHandler, libcimgui), Cvoid, ())
end

# no prototype is found for this function at cimgui_te.h:945:20, please use with caution
...
function cImGuiTestEngine_PerfToolAppendToCSV(entry, filename)
    ccall((:cImGuiTestEngine_PerfToolAppendToCSV, libcimgui), Cvoid, (Ptr{ImGuiPerfToolEntry}, Ptr{Cchar}), entry, filename)
end

# no prototype is found for this function at cimgui_te.h:956:38, please use with caution
...
# no prototype is found for this function at cimgui_te.h:983:36, please use with caution
...
# no prototype is found for this function at cimgui_te.h:999:35, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1014:30, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1025:27, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1045:39, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1050:44, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1059:38, please use with caution
...
function ImGuiTestContext_ItemIsVisible(self, ref)
    ccall((:ImGuiTestContext_ItemIsVisible, libcimgui), Bool, (Ptr{ImGuiTestContext}, ImGuiTestRef), self, ref)
end
...
function ImGuiTestContext_TableSetColumnEnabled_int(self, ref, column_n, enabled)
    ccall((:ImGuiTestContext_TableSetColumnEnabled_int, libcimgui), Cvoid, (Ptr{ImGuiTestContext}, ImGuiTestRef, Cint, Bool), self, ref, column_n, enabled)
end

function ImGuiTestContext_TableSetColumnEnabled_Str(self, ref, label, enabled)
    ccall((:ImGuiTestContext_TableSetColumnEnabled_Str, libcimgui), Cvoid, (Ptr{ImGuiTestContext}, ImGuiTestRef, Ptr{Cchar}, Bool), self, ref, label, enabled)
end

function ImGuiTestContext_TableResizeColumn_int(self, ref, column_n, width)
    ccall((:ImGuiTestContext_TableResizeColumn_int, libcimgui), Cvoid, (Ptr{ImGuiTestContext}, ImGuiTestRef, Cint, Cfloat), self, ref, column_n, width)
end

function ImGuiTestContext_TableResizeColumn_Str(self, ref, label, width)
    ccall((:ImGuiTestContext_TableResizeColumn_Str, libcimgui), Cvoid, (Ptr{ImGuiTestContext}, ImGuiTestRef, Ptr{Cchar}, Cfloat), self, ref, label, width)
end
...
function ImGuiTestContext__ScrollVerifyScrollMax(self, ref)
    ccall((:ImGuiTestContext__ScrollVerifyScrollMax, libcimgui), Cvoid, (Ptr{ImGuiTestContext}, ImGuiTestRef), self, ref)
end
...
# no prototype is found for this function at cimgui_te.h:1287:43, please use with caution
function ImGuiTestEnginePerfRecord_ImGuiTestEnginePerfRecord()
    ccall((:ImGuiTestEnginePerfRecord_ImGuiTestEnginePerfRecord, libcimgui), Ptr{ImGuiTestEnginePerfRecord}, ())
end

function ImGuiTestEnginePerfRecord_UpdateValueForCurrentFrame(self, v_ms)
    ccall((:ImGuiTestEnginePerfRecord_UpdateValueForCurrentFrame, libcimgui), Cvoid, (Ptr{ImGuiTestEnginePerfRecord}, Cdouble), self, v_ms)
end

function ImGuiTestEnginePerfRecord_destroy(self)
    ccall((:ImGuiTestEnginePerfRecord_destroy, libcimgui), Cvoid, (Ptr{ImGuiTestEnginePerfRecord},), self)
end

# no prototype is found for this function at cimgui_te.h:1293:33, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1297:36, please use with caution
...
# no prototype is found for this function at cimgui_te.h:1308:31, please use with caution
...
function ImGuiPerfTool__ShowEntriesTableBatches(self)
    ccall((:ImGuiPerfTool__ShowEntriesTableBatches, libcimgui), Cvoid, (Ptr{ImGuiPerfTool},), self)
end

function ImGuiPerfTool__SetBaseline(self, batch_index, test_index)
    ccall((:ImGuiPerfTool__SetBaseline, libcimgui), Cvoid, (Ptr{ImGuiPerfTool}, Cint, Cint), self, batch_index, test_index)
end
